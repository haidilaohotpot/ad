...
public class AdUnitObject {
    ...
    void update(AdUnitObject newObject) {
        ...
        if (null!=newObject.getUnitId()) this.unitId = newObject.getUnitId();

        if (null != newObject.getUnitStatus()) this.unitStatus = newObject.getUnitStatus();

        if (null != newObject.getPositionType()) this.positionType = newObject.getPositionType();

        if (null != newObject.getPlanId()) this.planId = newObject.getPlanId();

        if (null != newObject.getAdPlanObject()) this.adPlanObject = newObject.getAdPlanObject();
